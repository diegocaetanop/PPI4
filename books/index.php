...
$pasta = '../img/Books/'; // acessa a pasta das fotos
            ...
            <div id="carouselExampleControls" class="carousel slide banner" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="imgBanner" src="../img/Books/banner/img0.jpg" alt="First slide">
                  </div>
                  <div class="carousel-item">
                      <img class="imgBanner" src="../img/Books/banner/img1.jpg" alt="Second slide">
                  </div>
                  <div class="carousel-item">
                      <img class="imgBanner" src="../img/Books/banner/img2.jpg" alt="Third slide">
                  </div>
                </div>
        ...
        <div class="container mb-3">
            <div class="container mb-3">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li class="nav-item mr-2">
                        <a class="nav-link btn btn-outline-info active" href="../books">Books</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="row justify-content-sm-center">
            <?php
                for($j=0;$j<$i;$j++){
                    echo"
                       <div class='col-sm-6 col-md-4 col-lg-3 item pb-3'><a href='$pasta"."img$j.jpg' data-lightbox='photos'><img class='img-fluid' src='$pasta"."img$j.jpg' alt='foto de books'></a></div>
                    ";
                }
            ?>
        </div>
