...
$mensagemVO->setIdDestino(1);
$mensagemVO->setIdOrigem($id);
...
<?php include '../../../repositorios/menuUsuario.php'; menuUsuario($_SESSION['link'],$path,$inicial,$escolha,$payment,$download) /* include './global.php'; menu site*/ ?>
<section>
    <div class="container">
        ...
        <div class="row">
            <aside class="col-md-2">
                <ul class="list-group">
                    <li class="list-group-item"><a data-toggle="modal" data-target="#exempleModal" href="">Escrever mensagem</a></li>
                    <li class="list-group-item"><a href="../index.php">Recebidas</a></li>
                </ul>
            </aside>
            <div class="col-md-10" style="border: solid 1px #ccc;border-radius: 3px">
                <h5 class="m-2 pl-3">Mensagens enviadas<hr></h5>
                <ul>
                    <?php
                            ...
                            <div class='modal-content'>
                              ...
                              <div class='modal-body'>
                                <form action='index.php' method='post'>
                                    ...
                                    <div class='form-group'>
                                        <label for='message-text' class='col-form-label'>Message Anterior:</label>
                            ...
                            <div class='modal-content'>
                              ...
                              <div class='modal-body'>
                                <div class='row'>
                                    ...
                                    <div class='col-md-6'>
                                        <p class='m-1 text-dark'> Você ainda nâo enviou nenhuma mensagem, envie agora mesmo. </p>
                                    </div>
                                </div>                                  
                              </div>
                              <div class='modal-footer'>
