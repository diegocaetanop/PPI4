...
$pasta = '../img/Casamentos/'; // acessa a pasta das fotos
...
<body>
    ...
    <section class="container-fluid text-center">
            ...
            <div id="carouselExampleControls" class="carousel slide banner" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="imgBanner" src="../img/Casamentos/banner/img0.jpg" alt="First slide">
                  </div>
                  <div class="carousel-item">
                      <img class="imgBanner" src="../img/Casamentos/banner/img1.jpg" alt="Second slide">
                  </div>
                  <div class="carousel-item">
                      <img class="imgBanner" src="../img/Casamentos/banner/img2.jpg" alt="Third slide">
                  </div>
                </div>
        ...
        <h3>Fotos de casamentos</h3>
        <hr style="height: 1px; background-color:#2E3842;width: 84%">
        <!-- menu -->
        <div class="container mb-3">
            <ul class="nav nav-pills nav-justified">
                <li class="nav-item mr-2">
                    <a class="nav-link btn btn-info" href="../casamentos">Casamentos</a>
                </li>
                <li class="nav-item mr-2">
    ...
    <?php
        for($j=0;$j<$i;$j++){
            echo"
               <div class='col-sm-6 col-md-4 col-lg-3 item pb-3'><a href='$pasta"."img$j.jpg' data-lightbox='photos'><img class='img-fluid' src='$pasta"."img$j.jpg' alt='foto de casamento'></a></div>
            ";
        }
    ?>
    </div>
