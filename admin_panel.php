...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg color-font bg-color">
        ...
        <div class="conteiner container">
            ...
            <a class="scroll navbar-brand" href="http://localhost/ppi4sem/">
                <img src="http://localhost/ppi4sem/img/LuisVinicius.png" id="logo" style="width: 60px;" alt="luis vinicius fotografias">PPI</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSite">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="scroll nav-link" href="./index.php">Inicio</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a id="a" class="dropdown-item" href="https://www.facebook.com/luistochero/">Facebook</a>
                        </div>
                    </li>
                </ul>
    ...
    <div id="login">
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <form action="admin_panel.php" method="post" class="formulario-login">
                    <img src='http://localhost/ppi4sem/img/LuisVinicius.png' id='logo' style='width: 80px;' alt='luis vinicius fotografias'>
                    <h3>Login</h3>
                    <?php
                        ...
                        if(isset($_POST['logar'])){
                            ...
                            $return=$pessoaDAO->login($pessoaVO,$conexao);
                            if($return==1){
                                header("location:gerenciamento/gerenciamento.php");
                            }
                        }

                    ?>
                        <label>Email:.</label>
                        <input type="text" id="nome" name="nome" placeholder="Usuario" class="input" required>
                        <br>
                        <label>Senha:</label>
